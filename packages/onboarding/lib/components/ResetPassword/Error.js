...
const ResetPasswordError = () => {
    ...
    return (react_1.default.createElement(styles_1.ConfirmWrapper, null,
        ...
        react_1.default.createElement(styles_1.ConfirmHeader, null, "Ups!"),
        react_1.default.createElement("p", null, "Something went wrong!"),
        react_1.default.createElement(styles_1.OnboardButton, { onClick: onSetStep('Reset') }, "Try again")));
};
exports.default = ResetPasswordError;
